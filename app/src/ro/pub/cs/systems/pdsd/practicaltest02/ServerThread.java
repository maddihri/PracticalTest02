...
public class ServerThread extends Thread {
    ...
    private HashMap<String, CustomValue> data = null;
    ...
    public ServerThread(int port) {
        ...
        this.data = new HashMap<String, CustomValue>();
    }
    ...
    public synchronized void setData(String city, CustomValue customValue) {
        this.data.put(city, customValue);
    }

    public synchronized HashMap<String, CustomValue> getData() {
        return data;
    }
